...
if __name__ == '__main__':
	...
	parser.add_argument('--dir_store_results', type=str, default="C:/Master_XMUM_usages/AI_Master_New/Experiment_Master_Project_EMP/ZeroDCE_ChangeWeights_EMP") 
	...
	# Model parameters
	parser.add_argument('--weightage_loss_TV', type=float, default = 200) # the weightage of loss_TV
	parser.add_argument('--weightage_loss_spa', type=float, default = 10) # the weightage of loss_spa
	parser.add_argument('--weightage_loss_col', type=float, default = 5) # the weightage of loss_col
	parser.add_argument('--weightage_loss_exp', type=float, default = 10) # the weightage of loss_exp
