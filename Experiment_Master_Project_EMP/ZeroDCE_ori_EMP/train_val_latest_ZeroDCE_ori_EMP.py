...
if __name__ == '__main__':
	...
	parser.add_argument('--BatchesNum_ImageGroups_VisualizationSample', type=int, default=16) # The number of image groups in the image grid = firstNBatches * batch_size during validation.: At each epoch, save the maximum first N batches of val_LL_image (Input), val_enhanced_image (Output), and val_ori_image (GroundTruth) image groups in validation as the samples to visualize the network performance 
