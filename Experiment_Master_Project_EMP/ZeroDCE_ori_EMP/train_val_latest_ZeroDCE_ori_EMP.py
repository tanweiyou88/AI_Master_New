...
if __name__ == '__main__':
	...
	parser.add_argument('--lr', type=float, default=0.01) # Learning rate. Add an argument type (optional argument) named lr. The value given to this argument type must be float data type. If no value is given to this argument type, then the default value will become the value of this argument type.
	...
	parser.add_argument('--scheduler_gamma', type=float, default = 0.1) # Multiplicative factor of learning rate decay (EG: _last_lr = lr*scheduler_gamma). "1" means disable scheduler; else, means enable scheduler with that gamma
