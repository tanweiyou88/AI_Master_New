...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_dir', type=str, default= "C:/Master_XMUM_usages/AI_Master_New/Experiment_Master_Project_EMP/Dataset_EMP/SICE_Dataset_Part1_EMP") # The absolute path of the source dataset
    parser.add_argument('--dst_dir', type=str, default="C:/Master_XMUM_usages/AI_Master_New/Experiment_Master_Project_EMP/Dataset_EMP/Preprocessed_SICE_Dataset_Part1_EMP") # The absolute path of the destination root folder that saves the rearranged dataset
