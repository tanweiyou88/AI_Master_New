...
def generate_save_TrainingResults_History():
	...
	epoch_training_average_loss_list_xmin = x_epoch_training_average_loss_list[epoch_training_average_loss_list_xpos]
	ax1 = fig.add_subplot(gs[0, :])
	ax1.plot(x_epoch_training_average_loss_list, epoch_training_average_loss_list, 'r') #row=0, col=0, 1
	...
	ax1.set_xticks(np.arange(min(x_epoch_training_average_loss_list), max(x_epoch_training_average_loss_list)+1, 1)) # set the interval of x-axis 
	...
	epoch_training_average_loss_TV_list_xmin = x_epoch_training_average_loss_TV_list[epoch_training_average_loss_TV_list_xpos]
	ax2 = fig.add_subplot(gs[1, 0])
	ax2.plot(x_epoch_training_average_loss_TV_list, epoch_training_average_loss_TV_list, 'b') # plot the graph
	...
	ax2.set_xticks(np.arange(min(x_epoch_training_average_loss_TV_list), max(x_epoch_training_average_loss_TV_list)+1, 1)) # set the interval of x-axis 
	...
	epoch_training_average_loss_spa_list_xmin = x_epoch_training_average_loss_spa_list[epoch_training_average_loss_spa_list_xpos]
	ax3 = fig.add_subplot(gs[1, 1])
	ax3.plot(x_epoch_training_average_loss_spa_list, epoch_training_average_loss_spa_list) # plot the graph
	...
	ax3.set_xticks(np.arange(min(x_epoch_training_average_loss_spa_list), max(x_epoch_training_average_loss_spa_list)+1, 1)) # set the interval of x-axis 
	...
	epoch_training_average_loss_col_list_xmin = x_epoch_training_average_loss_col_list[epoch_training_average_loss_col_list_xpos]
	ax4 = fig.add_subplot(gs[2, 0])
	ax4.plot(x_epoch_training_average_loss_col_list, epoch_training_average_loss_col_list) # plot the graph
	...
	ax4.set_xticks(np.arange(min(x_epoch_training_average_loss_col_list), max(x_epoch_training_average_loss_col_list)+1, 1)) # set the interval of x-axis 
	...
	epoch_training_average_loss_exp_list_xmin = x_epoch_training_average_loss_exp_list[epoch_training_average_loss_exp_list_xpos]
	ax5 = fig.add_subplot(gs[2, 1])
	ax5.plot(x_epoch_training_average_loss_exp_list, epoch_training_average_loss_exp_list) # plot the graph
	...
	ax5.set_xticks(np.arange(min(x_epoch_training_average_loss_exp_list), max(x_epoch_training_average_loss_exp_list)+1, 1)) # set the interval of x-axis 
...
def generate_save_ValidationResults_History():
	...
	epoch_validation_average_psnr_list_xmax = x_epoch_validation_average_psnr_list[epoch_validation_average_psnr_list_xpos]
	ax6 = fig.add_subplot(gs[0, 0])
	ax6.plot(x_epoch_validation_average_psnr_list, epoch_validation_average_psnr_list, 'b') #row=0, col=0, 1
	...
	ax6.set_xticks(np.arange(min(x_epoch_validation_average_psnr_list), max(x_epoch_validation_average_psnr_list)+1, 1)) # set the interval of x-axis 
	...
	epoch_validation_average_ssim_list_xmax = x_epoch_validation_average_ssim_list[epoch_validation_average_ssim_list_xpos]
	ax7 = fig.add_subplot(gs[0, 1])
	ax7.plot(x_epoch_validation_average_ssim_list, epoch_validation_average_ssim_list, 'b') #row=0, col=0, 1
	...
	ax7.set_xticks(np.arange(min(x_epoch_validation_average_ssim_list), max(x_epoch_validation_average_ssim_list)+1, 1)) # set the interval of x-axis 
	...
	epoch_validation_average_mae_list_xmin = x_epoch_validation_average_mae_list[epoch_validation_average_mae_list_xpos]
	ax8 = fig.add_subplot(gs[1, 0])
	ax8.plot(x_epoch_validation_average_mae_list, epoch_validation_average_mae_list, 'b') #row=0, col=0, 1
	...
	ax8.set_xticks(np.arange(min(x_epoch_validation_average_mae_list), max(x_epoch_validation_average_mae_list)+1, 1)) # set the interval of x-axis 
	...
	epoch_validation_average_lpips_list_xmin = x_epoch_validation_average_lpips_list[epoch_validation_average_lpips_list_xpos]
	ax9 = fig.add_subplot(gs[1, 1])
	ax9.plot(x_epoch_validation_average_lpips_list, epoch_validation_average_lpips_list, 'b') #row=0, col=0, 1
	...
	ax9.set_xticks(np.arange(min(x_epoch_validation_average_mae_list), max(x_epoch_validation_average_mae_list)+1, 1)) # set the interval of x-axis 
...
# 4) Summary: Take this script as the template to perform model training
# Instruction: Use this script to deploy model training
