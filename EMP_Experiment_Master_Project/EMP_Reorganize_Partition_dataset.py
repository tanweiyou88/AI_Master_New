...
if __name__ == '__main__':
    ...
    # Input Parameters
    parser.add_argument('--src_dir', type=str, default= "D:/AI_Master_New/EMP_Experiment_Master_Project/EMP_SICE_Dataset_Part1") # The absolute path of the source dataset
    parser.add_argument('--dst_dir', type=str, default="D:/AI_Master_New/EMP_Experiment_Master_Project/EMP_Reorganized_SICE_Dataset_Part1") # The absolute path of the destination root folder that saves the rearranged dataset
